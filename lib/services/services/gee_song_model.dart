...
//
//     final geeSongModel = geeSongModelFromJson(jsonString);

import 'dart:convert';

GeeSongModel geeSongModelFromJson(String str) => GeeSongModel.fromJson(json.decode(str));

String geeSongModelToJson(GeeSongModel data) => json.encode(data.toJson());
...
class GeeSongModel {
  ...
  factory GeeSongModel.fromJson(Map<String, dynamic> json) => GeeSongModel(
    ...
    trackPosition: json["track_position"] == null ? null : json["track_position"],
    diskNumber: json["disk_number"] == null ? null : json["disk_number"],
    rank: json["rank"] == null ? null : json["rank"],
    releaseDate: json["release_date"] == null ? null : DateTime.parse(json["release_date"]),
    explicitLyrics: json["explicit_lyrics"] == null ? null : json["explicit_lyrics"],
    explicitContentLyrics: json["explicit_content_lyrics"] == null ? null : json["explicit_content_lyrics"],
    explicitContentCover: json["explicit_content_cover"] == null ? null : json["explicit_content_cover"],
    ...
    availableCountries: json["available_countries"] == null ? null : List<String>.from(json["available_countries"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "explicit_content_lyrics": explicitContentLyrics == null ? null : explicitContentLyrics,
    "explicit_content_cover": explicitContentCover == null ? null : explicitContentCover,
    "preview": preview == null ? null : preview,
    "bpm": bpm == null ? null : bpm,
    "gain": gain == null ? null : gain,
    "available_countries": availableCountries == null ? null : List<dynamic>.from(availableCountries.map((x) => x)),
...
class Artist {
  ...
  factory Artist.fromJson(Map<String, dynamic> json) => Artist(
    ...
    pictureSmall: json["picture_small"] == null ? null : json["picture_small"],
    pictureMedium: json["picture_medium"] == null ? null : json["picture_medium"],
